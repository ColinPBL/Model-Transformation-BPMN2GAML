...
/**
 * This is the item provider adapter for a {@link BPMN4GAMA.FlowNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FlowNodeItemProvider extends FlowElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FlowNode_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FlowNode_name_feature", "_UI_FlowNode_type"),
				 BPMN4GAMAPackage.Literals.FLOW_NODE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BPMN4GAMAPackage.Literals.FLOW_NODE__INCOMING,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BPMN4GAMAPackage.Literals.FLOW_NODE__OUTGOING,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FlowNode.class)) {
			case BPMN4GAMAPackage.FLOW_NODE__NAME:
