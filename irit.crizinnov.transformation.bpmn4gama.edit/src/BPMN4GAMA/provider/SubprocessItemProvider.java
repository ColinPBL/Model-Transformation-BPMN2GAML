...
/**
 * This is the item provider adapter for a {@link BPMN4GAMA.Subprocess} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Subprocess_processRef_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Subprocess_processRef_feature", "_UI_Subprocess_type"),
				 BPMN4GAMAPackage.Literals.SUBPROCESS__PROCESS_REF,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addIsMultiInstancePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Subprocess_isMultiInstance_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Subprocess_isMultiInstance_feature", "_UI_Subprocess_type"),
				 BPMN4GAMAPackage.Literals.SUBPROCESS__IS_MULTI_INSTANCE,
				 true,
				 false,
				 false,
