...
/**
 * This is the item provider adapter for a {@link BPMN4GAMA.StartEvent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StartEventItemProvider extends CatchEventItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StartEvent_eventType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StartEvent_eventType_feature", "_UI_StartEvent_type"),
				 BPMN4GAMAPackage.Literals.START_EVENT__EVENT_TYPE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StartEvent.class)) {
			case BPMN4GAMAPackage.START_EVENT__EVENT_TYPE:
