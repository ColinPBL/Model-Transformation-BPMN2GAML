...
/**
 * This is the item provider adapter for a {@link BPMN4GAMA.Activity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BPMN4GAMAPackage.Literals.ACTIVITY__BOUNDARY_EVENT_REFS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addIsLoopPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Activity_isLoop_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Activity_isLoop_feature", "_UI_Activity_type"),
				 BPMN4GAMAPackage.Literals.ACTIVITY__IS_LOOP,
				 true,
				 false,
				 false,
