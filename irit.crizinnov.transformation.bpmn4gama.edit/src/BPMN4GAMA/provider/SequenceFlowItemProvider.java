...
/**
 * This is the item provider adapter for a {@link BPMN4GAMA.SequenceFlow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BPMN4GAMAPackage.Literals.SEQUENCE_FLOW__TARGET_REF,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BPMN4GAMAPackage.Literals.SEQUENCE_FLOW__SOURCE_REF,
				 true,
				 false,
				 true,
				 null,
