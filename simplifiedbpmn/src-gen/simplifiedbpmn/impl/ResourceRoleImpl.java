 ...
 * </p>
 * <ul>
 *   <li>{@link simplifiedbpmn.impl.ResourceRoleImpl#getName <em>Name</em>}</li>
 *   <li>{@link simplifiedbpmn.impl.ResourceRoleImpl#getProcesses <em>Processes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResourceRoleImpl extends MinimalEObjectImpl.Container implements ResourceRole {
	...
	protected EClass eStaticClass() {
		return SimplifiedbpmnPackage.Literals.RESOURCE_ROLE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimplifiedbpmnPackage.RESOURCE_ROLE__NAME, oldName,
					name));
	}
	...
	public EList<FlowElementContainer> getProcesses() {
		if (processes == null) {
			processes = new EObjectWithInverseResolvingEList<FlowElementContainer>(FlowElementContainer.class, this,
					SimplifiedbpmnPackage.RESOURCE_ROLE__PROCESSES,
					SimplifiedbpmnPackage.FLOW_ELEMENT_CONTAINER__RESOURCE);
		}
		return processes;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case SimplifiedbpmnPackage.RESOURCE_ROLE__PROCESSES:
