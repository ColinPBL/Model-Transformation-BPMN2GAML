 ...
 * </p>
 * <ul>
 *   <li>{@link simplifiedbpmn.impl.IntermediateThrowEventImpl#getEventType <em>Event Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntermediateThrowEventImpl extends ThrowEventImpl implements IntermediateThrowEvent {
	...
	protected EClass eStaticClass() {
		return SimplifiedbpmnPackage.Literals.INTERMEDIATE_THROW_EVENT;
	}
	...
	public void setEventType(EventType newEventType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					SimplifiedbpmnPackage.INTERMEDIATE_THROW_EVENT__EVENT_TYPE, oldEventType, eventType));
	}
