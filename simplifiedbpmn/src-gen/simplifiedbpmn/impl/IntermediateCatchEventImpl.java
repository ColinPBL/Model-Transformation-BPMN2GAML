 ...
 * </p>
 * <ul>
 *   <li>{@link simplifiedbpmn.impl.IntermediateCatchEventImpl#getEventType <em>Event Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntermediateCatchEventImpl extends CatchEventImpl implements IntermediateCatchEvent {
	...
	protected EClass eStaticClass() {
		return SimplifiedbpmnPackage.Literals.INTERMEDIATE_CATCH_EVENT;
	}
	...
	public void setEventType(EventType newEventType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					SimplifiedbpmnPackage.INTERMEDIATE_CATCH_EVENT__EVENT_TYPE, oldEventType, eventType));
	}
