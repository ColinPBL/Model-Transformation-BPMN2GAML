 ...
 * </p>
 * <ul>
 *   <li>{@link BPMN4GAMA.impl.StartEventImpl#getEventType <em>Event Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StartEventImpl extends CatchEventImpl implements StartEvent {
	...
	protected EClass eStaticClass() {
		return BPMN4GAMAPackage.Literals.START_EVENT;
	}
	...
	public void setEventType(EventType newEventType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN4GAMAPackage.START_EVENT__EVENT_TYPE, oldEventType, eventType));
	}
