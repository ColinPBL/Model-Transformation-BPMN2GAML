 ...
 * </p>
 * <ul>
 *   <li>{@link BPMN4GAMA.impl.GatewayImpl#getGatewayDirection <em>Gateway Direction</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class GatewayImpl extends FlowNodeImpl implements Gateway {
	...
	protected EClass eStaticClass() {
		return BPMN4GAMAPackage.Literals.GATEWAY;
	}
	...
	public void setGatewayDirection(GatewayDirection newGatewayDirection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN4GAMAPackage.GATEWAY__GATEWAY_DIRECTION, oldGatewayDirection, gatewayDirection));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMN4GAMAPackage.GATEWAY__GATEWAY_DIRECTION:
