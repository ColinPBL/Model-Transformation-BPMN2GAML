 ...
 * </p>
 * <ul>
 *   <li>{@link BPMN4GAMA.impl.IntermediateCatchEventImpl#getEventType <em>Event Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntermediateCatchEventImpl extends CatchEventImpl implements IntermediateCatchEvent {
	...
	protected EClass eStaticClass() {
		return BPMN4GAMAPackage.Literals.INTERMEDIATE_CATCH_EVENT;
	}
	...
	public void setEventType(EventType newEventType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN4GAMAPackage.INTERMEDIATE_CATCH_EVENT__EVENT_TYPE, oldEventType, eventType));
	}
