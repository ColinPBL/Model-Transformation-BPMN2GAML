 ...
 * @generated
 */
public class BPMN4GAMASwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case BPMN4GAMAPackage.AND_GATEWAY: {
				...
				if (result == null) result = caseFlowNode(andGateway);
			...
			case BPMN4GAMAPackage.OR_GATEWAY: {
				...
				if (result == null) result = caseGateway(orGateway);
				if (result == null) result = caseFlowNode(orGateway);
				if (result == null) result = caseFlowElement(orGateway);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BPMN4GAMAPackage.PROCESS: {
				BPMN4GAMA.Process process = (BPMN4GAMA.Process)theEObject;
				T result = caseProcess(process);
				if (result == null) result = caseFlowElementContainer(process);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case BPMN4GAMAPackage.XOR_GATEWAY: {
				...
				if (result == null) result = caseFlowNode(xorGateway);
	 ...
	 * @generated
	 */
	public T caseProcess(BPMN4GAMA.Process object) {
		return null;
	}
