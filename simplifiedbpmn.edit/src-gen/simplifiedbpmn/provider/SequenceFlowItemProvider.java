...
/**
 * This is the item provider adapter for a {@link simplifiedbpmn.SequenceFlow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SequenceFlowItemProvider extends FlowElementItemProvider {
	...
	protected void addTargetRefPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						SimplifiedbpmnPackage.Literals.SEQUENCE_FLOW__TARGET_REF, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_SequenceFlow_sourceRef_feature",
								"_UI_SequenceFlow_type"),
						SimplifiedbpmnPackage.Literals.SEQUENCE_FLOW__SOURCE_REF, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		return getString("_UI_SequenceFlow_type");
	}
