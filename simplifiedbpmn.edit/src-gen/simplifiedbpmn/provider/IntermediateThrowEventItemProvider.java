...
/**
 * This is the item provider adapter for a {@link simplifiedbpmn.IntermediateThrowEvent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IntermediateThrowEventItemProvider extends ThrowEventItemProvider {
	...
	protected void addEventTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_IntermediateThrowEvent_eventType_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_IntermediateThrowEvent_eventType_feature",
								"_UI_IntermediateThrowEvent_type"),
						SimplifiedbpmnPackage.Literals.INTERMEDIATE_THROW_EVENT__EVENT_TYPE, true, false, false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(IntermediateThrowEvent.class)) {
